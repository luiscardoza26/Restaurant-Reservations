        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link" href="reservations.php">Gestionar Reservas</a>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_restaurant.php?id=<?php echo $restaurant['id']; ?>" class="btn edit-general-btn"><i class="fa-regular fa-pen-to-square"></i></a>
                        <a href="delete_restaurant.php?id=<?php echo $restaurant['id']; ?>" class="btn btn-cancel"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
